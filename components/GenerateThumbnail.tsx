...
const GenerateThumbnail = ({setImage, setImageStorageId, image, imagePrompt, setImagePrompt} : GenerateThumbnailProps) => {
    ...
    const generateImage = async() => {
        ...
        try{
            ...
            console.log(error)
            toast({
                title: "Error while creating your thumbnail",
                variant: "destructive",
            })
        }
    }
    ...
    const handleImage = async(blob: Blob, fileName: string) => {
        ...
        try{
            ...
            toast({
                title: "Thumbnail Generated Succesfully",
              })
        } catch(error){
            console.log(error)
            toast({
  ...
  return (
    <>
        ...
        <div className='image_div' onClick={() => imageRef?.current?.click()}>
            ...
            {!isImageLoading ?(
                <Image src="/icons/upload-image.svg" width={50} height={50} alt="upload image"/>
            ):(
            ...
            <div className='flex flex-col items-center gap-1'>
                ...
                <p className='font-normal text-12 text-gray-1'>SVG, PNG, JPG OR GTF (max. 1080x1080px) </p>
            </div>
        </div>
    )}
    {image && (
