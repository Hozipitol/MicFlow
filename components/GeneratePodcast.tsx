...
const useGeneratedPodcast = ({setAudio, voiceType, voicePrompt, setAudioStorageId}: GeneratePodcastProps) => {

    //logic for generatign podcast 
    ...
    const generatePodcast = async () => {
        ...
        try{
            ...
            setIsGenerating(false);
            toast({
                title: "Podcast Generated Succesfully",
              })
            
        } catch(error){
            toast({
                title: "Error while creating your podcast",
                variant: "destructive",
...
const GeneratePodcast = (
    props: GeneratePodcastProps) => {
        const {isGenerating, generatePodcast} = useGeneratedPodcast(props);
  return (
    <div>
